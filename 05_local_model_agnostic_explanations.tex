...
\paragraph{Notes}
\begin{itemize}
	\item Sensitive to kernel width choice.
...
\begin{itemize}
	...
	\item $val_x(S  \bigcup \{j\})$: Prediction value using features in $S$ and $j$
...
The average prediction with only the features in the coalition.
\begin{equation}
